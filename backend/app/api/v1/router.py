...
from app.api.v1.endpoints import auth, progetti, personale, sal, timesheet, config, partner, admin, notifiche, sync, proposte, erogazioni, gantt_personale, dipartimenti, autorizzazioni_spesa, rimborsi_spesa
